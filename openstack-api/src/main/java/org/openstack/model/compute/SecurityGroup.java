...
public class SecurityGroup implements Serializable {
	...
	public String getName() {
		/*
		 * if (nameAttribute == null) { return nameElement; } if (nameElement == null) { return nameAttribute; } if
		 * (!nameElement.equals(nameAttribute)) throw new IllegalStateException(); return nameElement;
		 */
		return name;
	}
	...
	public void setName(String name) {
		this.name = name;
		/*
		 * this.nameAttribute = name; this.nameElement = name;
		 */
	}
	...
	public String toString() {
		return "SecurityGroup [id=" + id + ", tenantId=" + tenantId + ", name=" + name + ", description=" + description
				+ ", rules=" + rules + "]";
	}
